...
public class AddRecords extends AppCompatActivity
    ...
    private DatabaseReference databaseReferenceItems, databaseReferenceUsers,databaseReference1,databaseReference2;
    Button btnInsert,btnEdit;
    EditText itemName,itemExp,txtAmount;
    DrawerLayout drawer;
    ImageView userIMG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextView = findViewById(R.id.txt_itemName57);
        txtAmount = findViewById(R.id.txtAmount2);
        ...
        databaseReference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                BatchAdapter batchAdapter = new BatchAdapter(AddRecords.this,batchList);
    ...
    private void itemDataAdd(String itemExp, String itemName)
    {
        batch.setBatchID(itemName);
        batch.setProductExp(itemExp);
        batch.setAmount(txtAmount.getText().toString());
        batch.setProductName(autoCompleteTextView.getText().toString());

        databaseReference2.child(itemName).setValue(batch);
        updateListed();
